...
const Index = () => {
	...
	return (
		<div onClick={showTerminal ? handleSkip : undefined}>
			<Helmet>
				<title>
					Onslaught2342 | Aspiring Ethical Hacker & Security
					Researcher
				</title>
				<meta
					name="description"
					content="Portfolio of Onslaught2342 — aspiring ethical hacker, security researcher, and developer building cybersecurity tools and encryption projects."
				/>
				<meta
					property="og:title"
					content="Onslaught2342 | Security Researcher"
				/>
				<meta
					property="og:description"
					content="Aspiring ethical hacker exploring cybersecurity, encryption, and advanced computing."
				/>
			</Helmet>
			<ConsoleInit />
